...
var UserItem = function (_a) {
    ...
    return (React.createElement("div", { className: "resource " + (selected && ' selected'), onClick: function () { return onSelect(user.id); } },
        React.createElement("div", { className: style.avatar },
            React.createElement("img", { width: "80px", src: user.avatar })),
        React.createElement("div", { className: "resource__details" },
            React.createElement("span", { className: "resource__details--primary" }, user.name),
            React.createElement("span", { className: "resource__details--secondary" }, user.status)),
        React.createElement("div", { className: "resource__checkmark" },
...
var UserList = function (_a) {
    ...
    return (React.createElement("ul", { className: "resource-list" }, users.map(function (user) { return (React.createElement(UserItem, { key: user.id, user: user, selected: selectedItems.length > 0 && selectedItems.includes(user.id), onSelect: toggleSelect })); })));
};
    ...
    return (React.createElement("span", null,
        ...
        React.createElement(Popover, { active: popoverActive },
            React.createElement("div", { className: "wrapper" },
                React.createElement("input", { type: "text", placeholder: "Search", className: "search", value: searchValue, onChange: function (e) { return setSearchValue(e.target.value); } }),
