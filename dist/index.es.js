...
var Popover = function (_a) {
    ...
    if (!active)
        return null;
    return React.createElement("div", { className: styles.popover }, children);
};
...
function Button(_a) {
    ...
    return (React.createElement("button", { className: plain ? styles$1.plain : '', onClick: onClick }, content));
}
...
var UserItem = function (_a) {
    ...
    return (React.createElement("div", { className: style.resource + " " + (selected && style.selected), onClick: function () { return onSelect(user.id); } },
        React.createElement("div", { className: style.avatar },
            React.createElement("img", { width: "80px", src: user.avatar })),
        React.createElement("div", { className: style.resourceDetails },
            React.createElement("span", { className: style.resourceDetailsPrimary }, user.name),
            React.createElement("span", { className: style.resourceDetailsSecondary }, user.status)),
        React.createElement("div", { className: style.resourceCheckmark },
            React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", width: "16", height: "16", viewBox: "0 0 16 16" },
                React.createElement("defs", null,
                    React.createElement("path", { id: "a", d: "M0 0h16v16H0z" })),
                React.createElement("g", { fill: "none", fillRule: "evenodd" },
                    React.createElement("g", null,
                        React.createElement("mask", { id: "b", fill: "#fff" },
                            React.createElement("use", { xlinkHref: "#a" })),
                        React.createElement("path", { fill: "#28AF2B", d: "M8 15c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7M8 0C3.588 0 0 3.59 0 8s3.588 8 8 8 8-3.59 8-8-3.588-8-8-8", mask: "url(#b)" })),
                    React.createElement("path", { fill: "#28AF2B", d: "M12.287 5.016a.518.518 0 0 0-.726-.001l-4.91 4.91-2.274-2.272a.517.517 0 0 0-.728 0 .515.515 0 0 0 .001.725l2.638 2.638a.521.521 0 0 0 .727 0l5.272-5.273a.513.513 0 0 0 0-.727" }))))));
};
var UserList = function (_a) {
    ...
    return (React.createElement("ul", { className: style.resourceList }, users.map(function (user) { return (React.createElement(UserItem, { key: user.id, user: user, selected: selectedItems.length > 0 && selectedItems.includes(user.id), onSelect: toggleSelect })); })));
};
var ResourcePicker = function (_a) {
    var resources = _a.resources, onConfirm = _a.onConfirm, children = _a.children;
    var _b = useState(false), popoverActive = _b[0], setPopoverActive = _b[1];
    ...
    return (React.createElement("span", null,
        clonedTrigger,
        React.createElement(Popover, { active: popoverActive },
            React.createElement("div", { className: style.wrapper },
                React.createElement("input", { type: "text", placeholder: "Search", className: style.search, value: searchValue, onChange: function (e) { return setSearchValue(e.target.value); } }),
                React.createElement(UserList, { users: filteredUsers() }),
                React.createElement("div", { className: style.actions },
                    React.createElement(Button, { plain: true, onClick: handleConfirm }, "Confirm"))))));
};
